...
class seq2seq():
    def __init__(self, config, vocab):
        ...
        def speaker_atten(encoder_state, attention_states, ans_emb,model_type='train'):
            with tf.variable_scope('speaker'):
                ...
                return outputs
        # pdb.set_trace()
        response = speaker_atten(question_state, question_output, response_emb,self.model_type)
    ...
    def get_batch(self, data_raw):
        ...
        for _ in range(0, len(data_raw), self._batch_size):
            ...
            list_all_batch.append({'Question': Question,'Response':Response,'weight': weight})
